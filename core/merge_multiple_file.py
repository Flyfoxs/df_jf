...
config={
    ...
    #
    #
    # 'var016': [('0.67950475000.csv', 1)],
    # 'var066': [('0.67950475000.csv', 1)],
    # 'var019': [('0.67950475000.csv', 1)],
    # 'var059': [('0.67950475000.csv', 1)],
    # 'var065': [('0.67950475000.csv', 1)],
    # #'var053': [('0.67950475000.csv', 1)], Drop
    # #'var018': [('0.67950475000.csv', 1)], Drop
    # 'var047': [('0.67950475000.csv', 1)],
    #
